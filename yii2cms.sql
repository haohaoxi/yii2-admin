...
CREATE TABLE `yunmei_statistics`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `admin_id` int(11) NOT NULL COMMENT '用户id',
  `admin_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户名称',
...
-- ----------------------------
INSERT INTO `yunmei_statistics` VALUES (1, 11, '唔带我去二', '', 0, '', '');
